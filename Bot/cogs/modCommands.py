...
class RemoveRoles(commands.Cog):
    ...
    async def removerole(self, ctx, member : discord.Member, role : discord.Role):
        ...
        await ctx.send(f'Removed the role {role.mention} to {member.mention}.')

class DM_Members(commands.Cog):
    def __init__(self, client):
        self.client = client
...
def setup(client):
    ...
    client.add_cog(RemoveRoles(client))
    client.add_cog(DM_Members(client))
    client.add_cog(CreateInvite(client))